...
public final class Constants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = realBot ? -Math.toRadians(356.37) : -Math.toRadians(21.97265625);
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = realBot ? -Math.toRadians(1.81) : -Math.toRadians(58.71093750000001);
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = realBot ? -Math.toRadians(32.88) : -Math.toRadians(309.27886962890625);
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = realBot ? -Math.toRadians(48.03) : -Math.toRadians(212.2890625);
